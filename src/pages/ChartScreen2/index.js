    ...
    return (
        ...
        <View>
            ...
            <Gap width={36}/>
                <KopiHitam/>
                <Gap width={43}/>
                <Text style={styles.subTittle}>Espresoo</Text>
            </View>
            <Gap height={50}/>
            <View>
            <View
            ...
            <View style={styles.tax}>
                ...
                <Gap width={211}/>
                <Text style={styles.rp}>Rp</Text>
                <Text style={styles.taxMoney}>1.500</Text>    
            </View>
            <Gap height={33}/>
            ...
            <View style={styles.subTotal}>
                ...
                <Gap width={162}/>
                <Text style={styles.rp}>Rp</Text>
                <Text style={styles.subTotalValue}>16.500</Text>    
            </View>
            <Gap height={33}/>
