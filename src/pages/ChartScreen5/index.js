    ...
    return (
        ...
        <View>
            ...
            <View style={styles.cartTotal}>
                ...
                <Text style={styles.money}>6.000</Text>
            </View>
            <Gap height={33}/>
            <View style={styles.tax}>
                ...
                <Gap width={211}/>
                <Text style={styles.rp}>Rp</Text>
                <Text style={styles.taxMoney}>600</Text>    
            </View>
            <Gap height={33}/>
            ...
            <View style={styles.subTotal}>
                ...
                <Gap width={162}/>
                <Text style={styles.rp}>Rp</Text>
                <Text style={styles.subTotalValue}>6.600</Text>    
            </View>
            <Gap height={33}/>
